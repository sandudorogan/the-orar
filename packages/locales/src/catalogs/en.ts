...
const en: MessageCatalog = {
	...
	importCsv: {
		...
		description: "Validate an Orar CSV v1 file, preview the contents, then replace this project.",
		dropTitle: "Drop a CSV file here",
		dropDescription:
			"Select a file or paste CSV text below. Nothing is replaced until you confirm.",
		...
		replaceWarning: "This overwrites the current project and its saved timetable snapshot.",
